  ...
  en: {
    translation: {
      ...
      services: {
        ...
        items: [
          { title: 'Web Development', poetic: 'From Idea to Interface', description: 'Seamless web experiences for every device.', tag: 'Frontend + Backend' },
          { title: 'Mobile Applications', poetic: 'Your Vision, In Every Pocket', description: 'Fluid mobile experiences engineered for daily retention. Intelligent apps that empower your business anywhere.', tag: 'iOS + Android' },
          { title: 'SaaS / Custom Solutions', poetic: 'Tailored for Your Business', description: 'Scalable SaaS and custom platforms engineered to grow with your vision.', tag: 'SaaS + Custom' },
          { title: 'AI Chatbots', poetic: 'Conversations That Convert', description: 'Intelligent chatbots designed to engage users, answer queries, and boost conversions 24/7.', tag: 'AI Automation' },
          { title: 'Cloud Platforms', poetic: 'Power Meets Flexibility', description: 'Secure, scalable cloud systems built for performance and growth.', tag: 'Cloud Native' },
          { title: 'UI / UX Design', poetic: 'Design That Connects', description: 'Intuitive interfaces and experiences that delight users and drive engagement.', tag: 'Design Systems' },
          { title: 'E-Commerce Solutions', poetic: 'Sell Smarter, Faster', description: 'Optimized online stores that convert visitors into loyal customers.', tag: 'Ecommerce' },
          { title: 'Digital Marketing', poetic: 'Growth Through Strategy', description: 'Data-driven campaigns that boost visibility, engagement, and ROI.', tag: 'Marketing' },
          { title: 'Social Media Marketing & Strategy', poetic: 'Your Brand, Everywhere', description: 'Targeted campaigns and strategies to expand your reach and influence.', tag: 'Social Strategy' },
          { title: 'Content Creation & Graphic Designing', poetic: 'Creativity That Converts', description: 'Compelling content and visuals crafted to capture attention and drive results.', tag: 'Content + Design' },
        ],
      },
      process: {
        lead: 'How We',
        accent: 'Work',
        poetic: 'Structured. Human. Relentless.',
        items: [
      ...
      about: {
        ...
        missionText1:
          'To architect powerful digital ecosystems that give businesses a measurable competitive advantage.',
        missionText2:
          'By combining technology, strategy, design, and data intelligence, we create solutions that accelerate growth, increase operational efficiency, strengthen market positioning, and deliver sustainable long-term value.',
        missionText3: 'Build smarter. Scale faster. Lead stronger.',
